...
# Suivi des resize en cours : vm_id -> statut
_resize_en_cours = {}
# Cache flavor ID -> nom pour éviter les appels répétés à Nova
_flavors_cache = {}


def _get_flavor_nom(nc, flavor_id: str) -> str:
    """Résout un ID de flavor numérique en nom lisible (ex: '2' -> 'm1.medium')."""
